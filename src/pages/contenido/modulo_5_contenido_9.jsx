            ...
            <div className="max-w-5xl mx-auto">
                <div className="game-card">
                    <div className="game-header">
                        <h2><span>📱</span> Reto 9: Sopa - SMS/Smishing</h2>
...
export default Modulo5Contenido9;