// src/pages/contenido/modulo_5_contenido_14.jsx
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import axios from "axios";
import { Trophy, XCircle } from "lucide-react";
import confetti from "canvas-confetti";
import '@/Css/modulo_5_contenido_14.css';

const API_URL = import.meta.env.VITE_API_URL || "http://localhost:4000";
const MODULO_ID = 5;
const NUM_CONTENIDO = 14;
const TIEMPO_JUEGO = 120;
const CALIFICACION_MINIMA = 6;

const Modulo5Contenido14 = () => {
            ...
            <div className="max-w-5xl mx-auto">
                <div className="game-card">
                    <div className="game-header">
                        <h2><span>💬</span> Reto 14: Sopa - SMS/Smishing</h2>
...
export default Modulo5Contenido14;