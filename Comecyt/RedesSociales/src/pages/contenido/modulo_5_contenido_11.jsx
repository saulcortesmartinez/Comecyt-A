// src/pages/contenido/modulo_5_contenido_11.jsx
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import axios from "axios";
import { Trophy, XCircle } from "lucide-react";
import confetti from "canvas-confetti";
import '@/Css/modulo_5_contenido_11.css';

const API_URL = import.meta.env.VITE_API_URL || "http://localhost:4000";
const MODULO_ID = 5;
const NUM_CONTENIDO = 11;
const TIEMPO_JUEGO = 120;
const CALIFICACION_MINIMA = 6;

const Modulo5Contenido11 = () => {
            ...
            <div className="max-w-5xl mx-auto">
                <div className="game-card">
                    <div className="game-header">
                        <h2><span>💬</span> Reto 11: Sopa - SMS/Smishing</h2>
...
export default Modulo5Contenido11;