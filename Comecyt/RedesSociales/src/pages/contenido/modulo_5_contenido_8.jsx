// src/pages/contenido/modulo_5_contenido_8.jsx
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import axios from "axios";
import { Clock, Trophy, XCircle } from "lucide-react";
import confetti from "canvas-confetti";
import '@/Css/modulo_5_contenido_8.css';
...
const Modulo5Contenido8 = () => {
    ...
    const wordPositions = {
        'SMS': [[0, 0], [0, 1], [0, 2]],
        'LINK': [[1, 0], [1, 1], [1, 2], [1, 3]],
        'BANCO': [[2, 0], [2, 1], [2, 2], [2, 3], [2, 4]],
        'CLAVE': [[3, 0], [3, 1], [3, 2], [3, 3], [3, 4]],
        'URGENCIA': [[4, 0], [4, 1], [4, 2], [4, 3], [4, 4], [4, 5], [4, 6], [4, 7]],
        'PHISHING': [[5, 0], [5, 1], [5, 2], [5, 3], [5, 4], [5, 5], [5, 6], [5, 7]],
        'NUMERO': [[6, 0], [6, 1], [6, 2], [6, 3], [6, 4], [6, 5]],
        'ALERTA': [[7, 0], [7, 1], [7, 2], [7, 3], [7, 4], [7, 5]]
    };
            ...
            <div className="max-w-5xl mx-auto">
                <div className="game-card">
                    <div className="game-header">
                        <h2><span>💬</span> Reto 8: Sopa - SMS/Smishing</h2>
...
export default Modulo5Contenido8;