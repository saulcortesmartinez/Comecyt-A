// src/pages/contenido/modulo_5_contenido_15.jsx
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import axios from "axios";
import { Trophy, XCircle } from "lucide-react";
import confetti from "canvas-confetti";
import '@/Css/modulo_5_contenido_15.css';

const API_URL = import.meta.env.VITE_API_URL || "http://localhost:4000";
const MODULO_ID = 5;
const NUM_CONTENIDO = 15;
const TIEMPO_JUEGO = 120;
const CALIFICACION_MINIMA = 6;

const Modulo5Contenido15 = () => {
    ...
    if (!progresoCargado) return <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', color: '#06b6d4' }}>Cargando reto final...</div>;
            ...
            <div className="max-w-5xl mx-auto">
                <div className="game-card">
                    <div className="game-header">
                        <h2><span>🏆</span> Reto 15: Sopa Final - SMS/Smishing</h2>
                        <p>Encuentra <strong>8 palabras</strong> sobre estafas por SMS y smishing. <strong>¡ÚLTIMO RETO DEL MÓDULO 5!</strong></p>
                    </div>
                        ...
                        <div className="victory-message">
                            {aprobo ? (
                                <>
                                    ...
                                    <h3>¡{foundWords.length === 8 ? 'MÓDULO 5 COMPLETADO' : 'MUY BIEN'}!</h3>
                    ...
                    <footer className="contenido-footer mt-8">
                        <div className="avance-mensaje">
                            ...
                            {puedeAvanzar && <p className="avance-texto toast-success">✅ ¡Módulo 5 completado!</p>}
                        </div>
                        <div className="botones-nav">
                            ...
                            <button className={`btn-siguiente ${!puedeAvanzar || guardando ? "btn-disabled" : ""}`}
                                ...
                                {guardando ? "Guardando..." : puedeAvanzar ? "FINALIZAR MÓDULO 5 🏆" : "Contenido Bloqueado 🔒"}
                            </button>
                        </div>
                    </footer>
                </div>
...
export default Modulo5Contenido15;