...
export default function Registro() {
    ...
    const rol = searchParams.get('rol') || 'alumno'; // Lee?rol=docente
    ...
    const handleRegistro = async (e) => {
        ...
        try {
            // ✅ USA LA RUTA NUEVA /api/auth/registrar que guarda en la tabla correcta
            const res = await fetch(`${API_URL}/api/auth/registrar`, {
                ...
                body: JSON.stringify({
                    ...
                    rol: rol // ✅ Manda el rol de la URL
                })
            });
